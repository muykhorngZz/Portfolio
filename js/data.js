...
const DATA = {
  ...
  /* ============================================================
     ...
     CERTIFICATES: every award and volunteering entry carries a PDF
     slot, shown as a small preview tile on the right of the row. It
     works exactly like the photos — just give it a path:

       pdf: "assets/certificates/my-file.pdf"

     Drop the file in assets/certificates/ under that exact name and
     the tile previews its first page; click it to open the full
     document. Until the file is there the tile shows an "Add
     my-file.pdf" placeholder, so the layout never breaks.

     The filenames below are suggestions — rename them to match the
     files you actually have. To use different placeholder wording:
       pdf: { src: "…/my-file.pdf", caption: "Your own text" }
     To drop the slot from an entry, remove its `pdf` line.
     ============================================================ */
  awardGroups: [
    {
      id: "achievements",
      ...
      items: [
        ...
        { name: "Champion Team — NUS Young Fellowship Program 2026", org: "National University of Singapore", year: "2026", note: "Under the theme \"AI and Graduate Research\".", photos: [], pdf: "assets/certificates/nus-young-fellowship-2026.pdf" },
        ...
        { name: "Selected for NUS Mathematics Track 2025", org: "National University of Singapore", year: "2025", note: "", photos: [], pdf: "assets/certificates/nus-math-track-2025.pdf" },
    ...
    },
    {
      ...
      items: [
        ...
        { name: "Team Leader — Student Sharing Knowledge Forum", org: "The Westline School", year: "2022", note: "Won the debate in a team leader role.", photos: [], pdf: "assets/certificates/westline-forum-2022.pdf" },
    ...
    },
    {
      ...
      items: [
        ...
        { name: "UNESCO UNITWIN Data Science Camp", org: "UNESCO UNITWIN", year: "2023", note: "Standard level completed.", photos: [], pdf: "assets/certificates/unesco-unitwin-camp.pdf" },
        { name: "AI Bootcamp — 100% Full Scholarship", org: "AI Bootcamp", year: "2025", note: "Awarded a full scholarship.", photos: [], pdf: "assets/certificates/ai-bootcamp-scholarship.pdf" },
  ...
  volunteering: [
    ...
    },
    {
      ...
      photos: [],
      pdf: "assets/certificates/tech-for-kids-2023.pdf"
    },
    {
      org: "ACE",
      role: "Organizer",
    ...
    },
    {
      ...
      photos: [],
      pdf: "assets/certificates/itc-china-scholarship-2023.pdf"
    }
  ]
};
